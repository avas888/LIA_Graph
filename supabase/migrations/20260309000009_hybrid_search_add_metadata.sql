...
-- Phase 6b: Add 10 metadata columns to hybrid_search RPC return type.
-- Ensures the hybrid (embeddings-ON) path has full metadata parity with
-- the FTS-scored prefilter and the JSONL retriever.
-- Requires: metadata columns added in migration 000008.
...
-- Re-grant access (CREATE OR REPLACE preserves grants but explicit is safer)
