...
_TOPIC_KEYWORDS: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    # vocabulary moved into `retencion_fuente_general` below; the 14 production
    # docs still bound to the v1 key get re-classified by the LLM into one of
    # the three retención conjuncts (general / declaracion_renta / sancionatorio)
    # on the next workers=4 rebuild — see artifacts/sme_pending/README.md.
    ...
    "firmeza_declaraciones": {
        "strong": (
            ...
            # SME 2026-04-25 (q10): contadores use civil-law vocabulary mixed
            # with tributario when asking about firmeza. Add the "prescribe /
            # cuestionar" family so q10 ("¿Cuándo prescribe la facultad de la
            # DIAN de cuestionar mi declaración de renta?") routes here.
            "prescribe la facultad",
            "prescribe la facultad de la dian",
            "prescripcion de la facultad",
            "prescripción de la facultad",
            "facultad de la dian de cuestionar",
            "facultad de fiscalizacion",
            "facultad de fiscalización",
            "dian puede revisar",
            "dian puede mirar atras",
            "dian puede mirar atrás",
            "cuantos anos atras dian",
            "cuántos años atrás dian",
            "cuantos años atras dian",
        ),
        "weak": (
            "firmeza",
            "tres años firmeza",
    ...
    # ── v2 taxonomy (2026-04-25) — SME-authored keyword_anchors for the 11
    # new top-levels + 2 new subtopics + 5 reclassified topics that previously
    # lacked router buckets. Phrases are quoted from the SME deliverable
    # (docs/aa_next/taxonomy_v2_sme_response.md §2) and follow the project
    # convention of no tildes in informal vocabulary.
    "impuesto_timbre": {
        "strong": (
            "impuesto de timbre",
            "timbre nacional",
    ...
    "parafiscales_seguridad_social": {
        "strong": (
            ...
            "presunción de costos independientes",
            "fiscalizacion ugpp",
            "fiscalización ugpp",
            "icbf",
            "sena",
    ...
    "reforma_laboral_ley_2466": {
        "strong": (
            ...
            "contrato a término fijo 2466",
            "aprendices sena reforma",
            "licencia menstrual",
            "transicion reforma laboral",
            "transición reforma laboral",
    ...
    "niif_microempresas": {
        "strong": (
            ...
            "información financiera microempresas",
        ),
        "weak": (),
    },
    "regimen_cambiario": {
        "strong": (
            ...
            "banco de la república cambios",
            "resolucion 1 2018 jdbr",
            "resolución 1 2018 jdbr",
            "sancion cambiaria",
            "sanción cambiaria",
        ),
        "weak": (
    ...
    # ── v2 reclassifications that previously lacked buckets ─────────────────
    ...
    "tarifas_renta_y_ttd": {
        "strong": (
            ...
            "art 240-1 et",
            "art 241 et",
            "tasa minima tributacion",
            "tasa mínima tributación",
            "ttd",
            "parrafo 6 art 240",
            "párrafo 6 art 240",
            "tarifa zona franca",
            "tarifa progresiva personas naturales",
        ),
        "weak": (
            "tarifa 35",
            "impuesto a cargo",
    ...
    "patrimonio_fiscal_renta": {
        ...
        "weak": (
            "valor patrimonial activo",
        ),
    },
    # ── v2 new subtopic: renta_presuntiva (under declaracion_renta) ─────────
    "renta_presuntiva": {
        "strong": (
            "renta presuntiva",
            "art 188 et",
            "art 189 et",
            "0.25 por ciento patrimonio",
            "depuracion patrimonio liquido",
            "depuración patrimonio líquido",
            "exclusion acciones renta presuntiva",
            "exclusión acciones renta presuntiva",
        ),
        "weak": (
            "base presuntiva",
        ),
    },
    # ── v2 reclassifications — renta family, SME §2.2 keyword_anchors ──────
    "ganancia_ocasional": {
        "strong": (
            "ganancia ocasional",
            "art 299 et",
    ...
    "beneficio_auditoria": {
        "strong": (
            ...
            "firmeza anticipada",
            "incremento inr",
            "incremento impuesto neto renta",
            "firmeza 6 meses",
            "firmeza 12 meses",
            # SME 2026-04-25 (q16): variants contadores use to ask about
            # eligibility — "le aplica el beneficio", "tiene derecho beneficio".
            "le aplica el beneficio de auditoria",
            "le aplica el beneficio de auditoría",
            "aplica el beneficio de auditoria",
            "aplica el beneficio de auditoría",
            "tiene derecho al beneficio de auditoria",
            "tiene derecho al beneficio de auditoría",
        ),
        "weak": (
            "beneficio auditoria",
            "beneficio auditoría",
    ...
    "conciliacion_fiscal": {
        "strong": (
            ...
            "diferencias permanentes",
            "dur 1.7.1",
            "resolucion 000071 de 2019",
            "resolución 000071 de 2019",
            "resolucion 000027 de 2024",
            "resolución 000027 de 2024",
            "esf y eri conciliacion",
            "esf y eri conciliación",
            "conciliar",
            "concilio",
        ),
        "weak": (
    ...
    "descuentos_tributarios_renta": {
        "strong": (
            ...
            "donaciones descuento",
            "cteI descuento",
            "impuestos exterior descuento",
        ),
        "weak": (
            "tax credit",
        ),
    ...
    # ── v2 new subtopic: zomac_zese_incentivos_geograficos ─────────────────
    "zomac_zese_incentivos_geograficos": {
        "strong": (
            "zomac",
            "zese",
            ...
            "zonas mas afectadas",
            "zonas más afectadas",
            "incentivos por ubicacion",
            "incentivos por ubicación",
            "tarifa progresiva regional",
            "san andres",
            "san andrés",
            "cucuta",
            "cúcuta",
    ...
    # Closes the router/coherence-gate vocabulary gap surfaced by the art. 107
    # ET topic-safety false-positive on 2026-05-10. The router classifies
    # these two topics via `_SUBTOPIC_OVERRIDE_PATTERNS` but, until now, the
    # coherence gate had no vocabulary to score them, so retrieved articles
    # always out-scored the (zero-scoring) classified topic and tripped the
    # safety guard. Test `test_topic_router_targets_are_all_gate_scoreable`
    # pins this invariant.
    "costos_deducciones_renta": {
        "strong": (
            ...
            "costo deducible",
            "costos deducibles",
            "deducción procedente",
            "deduccion procedente",
            "costo procedente",
            "costos procedentes",
            ...
            "rechazo de deduccion",
            "rechazo de costo",
            "rechazo de costos",
            "rechazo costos y deducciones",
            ...
            "tope de deducción",
            "tope de deduccion",
            "soporte de la deducción",
            "soporte de la deduccion",
            # Art. 107 ET ("expensas necesarias deducibles") is the
            # foundational deducción article and has no other domain
            # meaning — keeping it strong is safe. Other articles in the
            # deducción cluster (105, 108, 115, 122, 771-5) are
            # multi-topic in casual usage (e.g. art. 115 historical-
            # reform queries) — they're matched via the conceptual
            # vocabulary above instead of by article number.
            "art. 107",
            "artículo 107",
            "articulo 107",
            "bancarización para deducciones",
            "pago en efectivo para deducciones",
        ),
        "weak": (
            "expensas",
            "causalidad",
            ...
            "gasto en renta",
            "costo en renta",
            "soporte fiscal de costos",
            "comprobante fiscal de gastos",
            "bancarización",
            "bancarizacion",
            "pagos en efectivo",
            "límite del 50% en efectivo",
            "limite del 50% en efectivo",
            "limitación al efectivo",
    ...
    "impuesto_consumo": {
        "strong": (
            ...
            "consumo en bares",
            "servicio de restaurante inc",
            "telefonía móvil inc",
            "telefonia movil inc",
            "datos móviles inc",
            "datos moviles inc",
            "vehículos de lujo inc",
            "vehiculos de lujo inc",
            "embarcaciones inc",
            "aerodinos inc",
            "bolsas plásticas inc",
            "bolsas plasticas inc",
            "art. 512-1 et",
            "artículo 512-1 et",
            "articulo 512-1 et",
            "art. 512-13 et",
