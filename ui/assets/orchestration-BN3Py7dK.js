import"./main-DICslklM.js";import{b as h}from"./bootstrap-CDL0BdR1.js";import"./index-DE07Z79R.js";import"./authGate-Bb2S6efH.js";import"./client-OE0sHIIg.js";function y(e){return`
  ...
  `}function x(e){return`
    <article class="orch-module-card" data-scope="${e.scope}">
      <div class="orch-module-topline">
        ...
        <span class="orch-module-stability" data-stability="${e.stability}">${N(e.stability)}</span>
      </div>
      <h3>${e.title}</h3>
  ...
  `}function P(e){return e==="shared"?"Compartido":e==="main-chat"?"Main chat":e==="normativa"?"Normativa":e==="interpretacion"?"Interpretación":"Ventanas lectoras"}function N(e){return e==="stable-facade"?"Facade estable":e==="surface-seam"?"Surface seam":"Implementación"}document.documentElement.classList.add("orch-page");document.body.classList.add("orch-page");h({missingRootMessage:"Missing #app root for orchestration page.",mountApp:f,renderShell:y,title:e=>e.t("app.title.orchestration")||"LIA - Orquestacion de Pipelines"});
