...
**Run timestamp:** 2026-05-11 05:50:27 PM Bogotá
**Server:** `http://127.0.0.1:8787`
**Run dir:** `evals/sme_validation_v1/runs/20260511T195358Z_phase10b_expert_panel_v1`
...
|---|---|
| Total scored | 21 |
| Accept (top-3 had expected file) | 12 |
| Wrong | 9 |
| Server error | 0 |
| Accept rate | **57.1%** |
| Decision (§5.4: ≥70% pass, 50–69% refine, <50% discard) | **REFINE** |
...
| `ep_iva_exentos_vs_excluidos_v1` | iva | accept | `CORE ya Arriba/IVA_COMPLETO/EXPERTOS/IVA-E02-interpretaciones-proporcionalidad-decreto-1474.md` |
...
| `ep_iva_regimen_responsables_v1` | iva | wrong | `—` |
...
| `ep_laboral_ugpp_desalarizacion_v1` | laboral | wrong | `—` |
| `ep_proc_devoluciones_riesgo_auditoria_v1` | procedimiento_tributario | accept | `CORE ya Arriba/Documents to branch and improve/Devoluciones_Saldos_Favor/Interpretacion_Expertos/dev_expertos_devoluciones.md` |
...
| `ep_retencion_autorretencion_especial_v1` | retencion_en_la_fuente | accept | `CORE ya Arriba/RETENCION_FUENTE_AGENTE/EXPERTOS/RET-E01-interpretaciones-retencion-riesgos-sanciones.md` |
| `ep_retencion_decreto_572_v1` | retencion_en_la_fuente | accept | `to upload/BRECHAS-SEMANA1-ABRIL-2026/RETENCION_D572/EXPERTOS/RET-E02-decreto-572-vs-art368-interpretaciones.md` |
