...
- 🟠 **Polish rejected on 17 qid(s)** (`polish_mode=rejected`): beneficio_auditoria_P1, beneficio_auditoria_P3, conciliacion_fiscal_P1, conciliacion_fiscal_P2, devoluciones_saldos_a_favor_P2, devoluciones_saldos_a_favor_P3, dividendos_y_distribucion_utilidades_P2, impuesto_patrimonio_personas_naturales_P1, impuesto_patrimonio_personas_naturales_P2, impuesto_patrimonio_personas_naturales_P3 … — `polish_skip_reason` distribution: anchors_stripped=4, invented_norm_lineage=1, invented_periods=12. The fix_v8 §3a substantive fallback should keep the answer useful when this fires; if the visible answers regressed, check the `polish.rejected.fallback_composed` trace step.
