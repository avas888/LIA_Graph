...
``match_canonical_shape`` entry point. Originally landed on the orphan
``fix_v7-truncated-tail-and-canonical-shapes`` branch (2026-04-30 L14)
and revived under fix_v22_may §9c P2-T-Orphan-1 — see that doc for
...
extend the table without code changes. Empty config = noop.
"""
