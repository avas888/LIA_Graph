import{o as P,f as D,d as R,e as z}from"./brandMark-CJ6GTOQ7.js";import{s as g,i as V}from"./format-CYFfBTRg.js";import{b}from"./button-1yFzSXrY.js";import{a as G}from"./stateBlock-CleM9k1B.js";import{i as p}from"./icons-BZwBwwSI.js";import"./bootstrap-CDL0BdR1.js";import"./index-DE07Z79R.js";import"./authGate-Bb2S6efH.js";import"./client-OE0sHIIg.js";import"./input-Byu2cnK9.js";import"./toasts-Dx3CUztl.js";import"./chip-Bjq03GaS.js";function at(m,r,d={}){const v=m.querySelector("#mobile-normativa-list"),S=m.querySelector("#mobile-normativa-empty");let h=[];function C(t){if(h=[...t],h.length===0){v.replaceChildren(),S.hidden=!1;return}S.hidden=!0,z(v,h)}function L(){h=[],v.replaceChildren(),S.hidden=!1}v.addEventListener("click",t=>{const i=t.target.closest(".mobile-citation-card");if(!i||t.target.closest("a"))return;const e=parseInt(i.dataset.citationIndex??"-1",10),n=h[e];n&&U(n)}),document.addEventListener("click",t=>{const i=t.target.closest(".mobile-depth-item-link");if(!i)return;t.preventDefault();const e=i.dataset.docId||"",n=i.dataset.docLabel||"",s=i.dataset.knowledgeClass||"practica_erp";e&&P(e,n,s)});function T(){return`
