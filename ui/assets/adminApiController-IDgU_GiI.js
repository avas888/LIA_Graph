import{g as u,A as g}from"./client-OE0sHIIg.js";import{c as E}from"./badge-UV61UhzD.js";import{c as f}from"./factCard-Cu0UJHPY.js";import"./chip-Bjq03GaS.js";let h=0;const y=20;function H(e,n){e.innerHTML=w();const t=e.querySelector("#admin-api-key-section"),a=e.querySelector("#admin-api-stats"),s=e.querySelector("#admin-api-logs"),o=e.querySelector("#admin-api-logs-pagination"),i=e.querySelector("#admin-api-logs-refresh");t&&C(t),a&&x(a),s&&o&&m(s,o,0),i==null||i.addEventListener("click",()=>{s&&o&&m(s,o,h)})}function w(){return`
