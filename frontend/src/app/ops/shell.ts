...
export function renderIngestionShell(i18n: I18nRuntime): string {
  return `
    ...
    <main class="ops-shell">
      <header class="app-header app-hero">
        <div class="hero-copy">
          <h1>${i18n.t("ops.ingestion.title")}</h1>
        </div>
      </header>
            ...
            <div class="ops-action-groups">
              ...
              <fieldset class="ops-action-group">
                ...
                <div class="ops-action-row">
                  ...
                  <button id="ingestion-delete-session" type="button" class="secondary-btn danger-btn">${i18n.t("ops.ingestion.actions.discardSession")}</button>
                </div>
              </fieldset>
            </div>
