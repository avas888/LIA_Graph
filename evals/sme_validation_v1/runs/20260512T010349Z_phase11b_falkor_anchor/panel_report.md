...
**Run timestamp:** 2026-05-11 08:07:23 PM Bogotá
**Server:** `http://127.0.0.1:8787`
**Run dir:** `evals/sme_validation_v1/runs/20260512T010349Z_phase11b_falkor_anchor`
...
|---|---|
| Total scored | 21 |
| Accept (top-3 had expected file) | 11 |
| Wrong | 10 |
| Server error | 0 |
| Accept rate | **52.4%** |
