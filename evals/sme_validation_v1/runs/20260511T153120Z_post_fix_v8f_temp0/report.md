...
**Run dir:** `/Users/ava-sensas/Developer/Lia_Graph/evals/sme_validation_v1/runs/20260511T153120Z_post_fix_v8f_temp0`
**Generated:** 2026-05-11 10:35:27 AM Bogotá
...
| descuentos_tributarios_renta | 🟡 served_acceptable | 🟡 served_acceptable | 🟢 served_strong |
...
| regimen_cambiario | 🟢 served_strong | 🟢 served_strong | 🟡 served_acceptable |
...
- 🟠 **Polish rejected on 18 qid(s)** (`polish_mode=rejected`): beneficio_auditoria_P1, beneficio_auditoria_P3, conciliacion_fiscal_P1, conciliacion_fiscal_P2, devoluciones_saldos_a_favor_P2, devoluciones_saldos_a_favor_P3, dividendos_y_distribucion_utilidades_P2, dividendos_y_distribucion_utilidades_P3, impuesto_patrimonio_personas_naturales_P1, impuesto_patrimonio_personas_naturales_P2 … — `polish_skip_reason` distribution: anchors_stripped=3, invented_norm_lineage=2, invented_periods=13. The fix_v8 §3a substantive fallback should keep the answer useful when this fires; if the visible answers regressed, check the `polish.rejected.fallback_composed` trace step.
