import"./main-bNgL_MjM.js";import{b as h}from"./bootstrap-DIavVI1A.js";import"./index-Jd8ZZgqP.js";import"./authGate-Bb2S6efH.js";import"./client-OE0sHIIg.js";function y(e){return`
  ...
  `}function P(e){return e==="shared"?"Compartido":e==="main-chat"?"Main chat":e==="normativa"?"Normativa":e==="interpretacion"?"Interpretación":"Ventanas lectoras"}function C(e){return e==="stable-facade"?"Facade estable":e==="surface-seam"?"Surface seam":"Implementación"}document.documentElement.classList.add("orch-page");document.body.classList.add("orch-page");h({missingRootMessage:"Missing #app root for orchestration page.",mountApp:f,renderShell:y,title:e=>e.t("app.title.orchestration")||"LIA - Orquestacion de Pipelines"});
