...
3. **Senate (last-resort fallback):** `http://www.secretariasenado.gov.co/senado/basedoc/decreto_1072_2015.html`
...
3. **URL** — the **exact source page** of whichever source you ended up using (hard requirement, no exceptions): for DIAN it's `https://normograma.dian.gov.co/dian/compilacion/docs/decreto_1072_2015.htm`; for MinTrabajo it's the URL of the PDF file itself (not the page that links to it); for the Senate fallback it's `http://www.secretariasenado.gov.co/senado/basedoc/decreto_1072_2015.html`. **Note in your delivery which source you used.** Never substitute a homepage or index.
