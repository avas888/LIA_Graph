import"./main-DICslklM.js";import{b as h}from"./bootstrap-CDL0BdR1.js";import"./index-DE07Z79R.js";import"./authGate-Bb2S6efH.js";import"./client-OE0sHIIg.js";function y(e){return`
        ...
        <div class="orch-brand">
          ...
          <div class="orch-brand-copy">
            ...
            <p class="orch-subtitle">
              Cómo viaja la información desde la pregunta del contador hasta la respuesta visible, qué contrato entrega cada capa y dónde terminan los límites entre lógica compartida, first turn vs follow-up del main chat, Normativa, Interpretación y las ventanas lectoras.
            </p>
          </div>
        </div>
    ...
    <section id="orch-surfaces" class="orch-section">
      ...
      <div class="orch-boundary-grid">
        ...
        <article class="orch-boundary-card" data-tone="future">
          ...
          <ul>
            <li>controller seam y ranking propios</li>
            <li>debe tener package/orchestration propios al restaurarse</li>
  ...
  `}function k(e){return`
    <article class="orch-module-card" data-scope="${e.scope}">
      <div class="orch-module-topline">
        <span class="orch-module-scope" data-scope-tone="${e.scope}">${P(e.scope)}</span>
        <span class="orch-module-stability" data-stability="${e.stability}">${C(e.stability)}</span>
      </div>
      <h3>${e.title}</h3>
  ...
  `}function P(e){return e==="shared"?"Compartido":e==="main-chat"?"Main chat":e==="normativa"?"Normativa":e==="interpretacion"?"Interpretación":"Ventanas lectoras"}function C(e){return e==="stable-facade"?"Facade estable":e==="surface-seam"?"Surface seam":"Implementación"}document.documentElement.classList.add("orch-page");document.body.classList.add("orch-page");h({missingRootMessage:"Missing #app root for orchestration page.",mountApp:_,renderShell:y,title:e=>e.t("app.title.orchestration")||"LIA - Orquestacion de Pipelines"});
