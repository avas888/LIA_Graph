...
**Run timestamp:** 2026-05-11 09:17:18 PM Bogotá
...
| `ep_renta_conciliacion_2516_v1` | declaracion_renta | accept | `CORE ya Arriba/RENTA/EXPERTOS/T05-conciliacion-fiscal-F2516-F2517-interpretaciones.md` |
...
| `ep_renta_patrimonio_niif_v1` | declaracion_renta | wrong | `—` |
| `ep_renta_ttd_paragrafo6_v1` | declaracion_renta | wrong | `—` |
| `ep_retencion_autorretencion_especial_v1` | retencion_en_la_fuente | wrong | `—` |
| `ep_retencion_decreto_572_v1` | retencion_en_la_fuente | accept | `CORE ya Arriba/RENTA/EXPERTOS/T11-retencion-fuente-decreto-572-2025-interpretaciones.md` |
