...
- **regimen_sancionatorio_extemporaneidad_P1** — 🔵 served_off_topic (mode=`graph_native`, cites=4, len=2802, effective_topic=`declaracion_renta`, fallback_reason=`None`)
  - **Q:** ¿Cuánto cobra la DIAN por presentar una declaración de renta tarde si no hay impuesto a cargo?
  - **A (head):** **Respuestas directas** ⏎  ⏎ *   **¿Cuánto cobra la DIAN por presentar una declaración de renta tarde si no hay impuesto a cargo?** ⏎     *   La sanción mínima aplicable es de 10 UVT (art. 639 ET). Para el año 2024, esto equivale a $471.000. ⏎     *   Esta sanción se aplica incluso si la declaración no arro
...
- **descuentos_tributarios_renta_P2** — 🔵 served_off_topic (mode=`graph_native`, cites=4, len=1962, effective_topic=`iva`, fallback_reason=`None`)
  ...
  - **A (head):** ### Respuestas directas ⏎  ⏎ *   **¿Puede tomar todo el IVA como descuento en la declaración de este año o tiene que repartirlo?** ⏎     *   El IVA pagado en la adquisición del horno industrial se puede tomar como descuento tributario en el impuesto de renta. ⏎     *   Este descuento se aplica en el año gra
...
### regimen_cambiario
- **regimen_cambiario_P1** — 🟠 served_weak (mode=`graph_native_partial`, cites=4, len=437, effective_topic=`regimen_cambiario`, fallback_reason=`pipeline_d_no_graph_primary_articles`)
  ...
  - **A (head):** **Ruta sugerida** ⏎ 1.  **PASO 1 — Identificar si la PYME Requiere Canalización Obligatoria:** Determinar si la operación de importación y pago al proveedor del exterior debe canalizarse a través del mercado cambiario regulado. (arts. paso-a-paso-pr-ctico y posiciones-de-expertos ET). ⏎  ⏎ **Riesgos y con
...
### conciliacion_fiscal
- **conciliacion_fiscal_P2** — 🔵 served_off_topic (mode=`graph_native`, cites=5, len=2168, effective_topic=`patrimonio_fiscal_renta`, fallback_reason=`None`)
...
- **conciliacion_fiscal_P3** — 🔵 served_off_topic (mode=`graph_native`, cites=4, len=3929, effective_topic=`patrimonio_fiscal_renta`, fallback_reason=`None`)
  ...
  - **A (head):** **Respuestas directas** ⏎  ⏎ *   **¿Cómo concilio el reconocimiento del activo por derecho de uso y el pasivo por arrendamiento bajo NIIF 16 con la normativa fiscal en el formato 2516?** ⏎  ⏎     *   Fiscalmente, el activo por derecho de uso y el pasivo por arrendamiento no se reconocen. El tratamiento fisc
