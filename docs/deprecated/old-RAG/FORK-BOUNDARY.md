...
This version of the boundary document still carries too much Pipeline C framing.
It is useful to understand what was originally copied or excluded, but it should
not drive graph-first design decisions now.
