...
-- Add chunk_section_type to document_chunks for section-level vigencia awareness.
-- Values: 'vigente', 'historical', 'operational', 'metadata', 'general', NULL (pre-reindex).

SET search_path TO public, extensions;

ALTER TABLE document_chunks ADD COLUMN IF NOT EXISTS chunk_section_type text;

COMMENT ON COLUMN document_chunks.chunk_section_type IS
    'Section type derived from markdown ## headings during ingestion: vigente, historical, operational, metadata, general';

-- ============================================================
-- fts_scored_prefilter: add chunk_section_type to return type
-- ============================================================
DROP FUNCTION IF EXISTS fts_scored_prefilter(text, text[], text, int, text, text, text);
DROP FUNCTION IF EXISTS fts_scored_prefilter(text, text[], text, int);
...
-- ============================================================
-- hybrid_search: add chunk_section_type to return type
-- ============================================================
